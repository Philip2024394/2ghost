...
import type { CellarProfile } from "../types/cellarTypes";
import { cellarActivityLabel } from "../utils/cellarHelpers";
...
export default function CellarLandscapeCard({ profile, liked, onLike, onGift }: Props) {
  const activityLabel = cellarActivityLabel(profile.last_seen_at);
  const isLive = activityLabel === "In the Cellar now";
  ...
  return (
    <motion.div
      ...
      style={{
        ...
        boxShadow: "0 4px 32px rgba(0,0,0,0.5), 0 0 0 0.5px rgba(192,57,43,0.08)",
    ...
    >
      ...
      <div style={{ width: "52%", flexShrink: 0, position: "relative", overflow: "hidden" }}>
        ...
        <div style={{
          ...
          background: "linear-gradient(to right, transparent 50%, rgba(14,3,3,0.97) 100%)",
          pointerEvents: "none",
        }} />
        {/* New arrival ribbon */}
        {profile.isNewArrival && (
          <div style={{
            ...
            background: `linear-gradient(90deg, #6b0f0f, ${CRIMSON})`,
        ...
        <div style={{
          ...
          <motion.div
            ...
            style={{
              ...
              background: isLive ? "#4ade80" : `rgba(192,57,43,0.8)`,
            }}
          />
        ...
        <div style={{ display: "flex", gap: 8, marginTop: "auto" }}>
          <motion.button
            ...
            style={{
              ...
              background: "rgba(192,57,43,0.08)", color: CRIMSON,
          ...
          <motion.button
            ...
            style={{
              ...
              background: liked
                ? `linear-gradient(135deg, #6b0f0f, ${CRIMSON})`

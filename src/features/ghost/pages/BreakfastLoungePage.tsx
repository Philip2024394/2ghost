...
const POOL: LoungeProfile[] = [
  ...
  { id:"id1",  seed:97,  ghostId:"Ghost-2241", city:"Jakarta",    country:"Indonesia", flag:"🇮🇩", floor:"Penthouse", floorColor:"#e8e4d0", mood:"Meeting-free morning ☀️",       gender:"m", age:32, about:"Startup founder from South Jakarta. Up early before the city traffic hits. Loves a strong kopi and a conversation that actually goes somewhere." },
  { id:"id2",  seed:103, ghostId:"Ghost-7753", city:"Bali",       country:"Indonesia", flag:"🇮🇩", floor:"Ensuite",   floorColor:"#cd7f32", mood:"Sunrise swim done ✓",            gender:"f", age:27, about:"Graphic designer based in Canggu. Splits time between client work and the ocean. Mornings are the only quiet part of the day." },
  { id:"id3",  seed:108, ghostId:"Ghost-3318", city:"Surabaya",   country:"Indonesia", flag:"🇮🇩", floor:"Casino",    floorColor:"#d4af37", mood:"Here for the nasi goreng 🍳",    gender:"m", age:35, about:"Logistics director, always travelling. Judges every hotel by the quality of its breakfast. This one passes." },
  { id:"id4",  seed:115, ghostId:"Ghost-9982", city:"Yogyakarta", country:"Indonesia", flag:"🇮🇩", floor:"Loft",      floorColor:"#a78bfa", mood:"Batik and black coffee ☕",       gender:"f", age:29, about:"Textile artist and occasional tour guide. Soft-spoken but has stories that'll hold the table for an hour." },
  { id:"id5",  seed:122, ghostId:"Ghost-5534", city:"Bandung",    country:"Indonesia", flag:"🇮🇩", floor:"Standard",  floorColor:"#c0c0c0", mood:"Indie playlist, window seat 🎧", gender:"m", age:24, about:"Music producer visiting for a collab session. Carries headphones everywhere but always has one ear out for good conversation." },
  { id:"id6",  seed:128, ghostId:"Ghost-1167", city:"Medan",      country:"Indonesia", flag:"🇮🇩", floor:"Ensuite",   floorColor:"#cd7f32", mood:"Will talk about food for hours", gender:"f", age:31, about:"Food journalist on assignment. Has eaten at 300 warungs and counting. Breakfast is research, not just a meal." },
  { id:"id7",  seed:134, ghostId:"Ghost-6645", city:"Jakarta",    country:"Indonesia", flag:"🇮🇩", floor:"Casino",    floorColor:"#d4af37", mood:"First coffee, then decisions",    gender:"f", age:26, about:"Corporate lawyer, works too hard. Travelling alone for the first time in three years and quietly enjoying every minute of it." },
  { id:"id8",  seed:141, ghostId:"Ghost-4423", city:"Lombok",     country:"Indonesia", flag:"🇮🇩", floor:"Loft",      floorColor:"#a78bfa", mood:"Surfer schedule, boardroom mind", gender:"m", age:30, about:"Marine conservation researcher. Spends half the year on the water. Has strong opinions on reef policy and even stronger ones about coffee." },
